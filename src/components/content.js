...
const Content = () => {
  return (
    <div className="flex w-full h-full md:pt-4 md:pl-20 p-4  font-montserrat  flex-wrap">
      <div className="w-full lg:w-8/12  text-letters md:py-6  ">
        <Tabs>
      ...
      <div className="w-full md:mt-8 lg:mt-0 py-6 md:px-6 lg:w-4/12 lg:pl-4">
